...
<head>
    ...
    <title>VR Community : Video</title>
</head>
...
<body>
    ...
    if(!isset($_POST['no'])||!isset($_POST['type'])||!isset($_POST['title'])||!isset($_POST['note'])||!isset($_POST['url']))
    {
        echo "<SCRIPT type='text/javascript'>
        alert(\"비정상적인 접근입니다.\");
        window.location.replace(\"../index.php\");</SCRIPT>";
    }
    //no가 넘어오지 않았을 때 오류를 내보내야함.
        ...
        <div class="row">
            <div class="col blog-main">
                <div class="pb-4 pt-md-5 mb-4 text-center">
                    <h2 class="font-italic">Video Posting</h2>
                    <p></p>
                </div>
                ...
                <div class="pt-md-3 border-top">
                    ...
                    <div class="blog-post">
                        <div class="row mb-2">
                            <div class="col-md">
                                <form action="moviemod_b.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="title">Title</label>
                                        <input type="text" value="<?=$title?>" class="form-control" name="title" placeholder="Title..." required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"  name="note" rows="3" required><?=$note?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="url">Post URL</label>
                                        <input type="text" class="form-control" name="url" value="<?=$url?>" placeholder="URL" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="filein">Thumbnail file upload</label>
