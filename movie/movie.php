...
<head>
    ...
    <title>VR Community : Movie</title>
...
<body>
   <?php
        ...
        <header class="blog-header py-3">
            <div class="row flex-nowrap justify-content-between align-items-center">
                ...
                <div class="col-4 d-flex justify-content-end align-items-center">
                    ...
                    <a class="btn btn-sm btn-outline-secondary" href="movieinsert_f.php" style="margin-right : 10px;">Posting</a>
                    <a class="btn btn-sm btn-outline-secondary" href="movieshow.php" style="margin-right : 10px;">Manage</a>
    ...
    <?php
        $sql = "select * from video where type = 'replay' order by no desc limit 3";
        ...
        <div class="row">
            <div class="col blog-main">
                <div class="pb-4 pt-md-5 mb-4 text-center">
                    <h2 class="font-italic">VR Video</h2>
                    <p>We can enjoy vivid images using VR!</p>
                </div>
                ...
                <?php
                $sql = "select * from video where type = 'world' order by no desc limit 3";
                ...
                <?php
                $sql = "select * from video where type = 'review' order by no desc limit 3";
