        ...
        <div class="row">
            <div class="col blog-main">
                <div class="pb-4 pt-md-5 mb-4 text-center">
                    <h2 class="font-italic">Community Reading</h2>
                    <p></p>
                </div>
                <?php
                ...
                <div class="pt-md-3 border-top">
                    ...
                    <div class="blog-post">
                        <div class="row mb-2">
                            <div class="col-md">
                                <form action="boardmod_b.php" method="post">
                                    <div class="form-group">
                                        <label for="title">Writer</label>
                                        <input type="text" value="<?=$row['id']?>" class="form-control" name="title" placeholder="Title..." readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="title">Title</label>
                                        <input type="text" value="<?=$row['title']?>" class="form-control" name="title" placeholder="Title..." readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="note">Posting note</label>
                                        <textarea class="form-control" name="note" rows="3" readonly><?=$row['note']?></textarea>
                                    </div>
                                    <button type="button" onclick="location.href='javascript:history.back()'" class="btn btn-primary">go back</button>
                                </form>
                            </div>
                        </div>
                    </div>
